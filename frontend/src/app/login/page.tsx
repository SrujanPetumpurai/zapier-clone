...
{/* Info*/}          <div className='pt-16 w-[50%]'>
                            <h1 className='text-3xl font-semibold pr-32 w-[100%]'>
                            ...
                            <div className="mt-8">
                            <Link className="text-white  text-xl py-2 px-3 w-[60%] bg-violet-500 rounded mt-8" href={''}>Explore Zapier Enterprise</Link></div>
                     </div> 
{/* loginInputs*/}   <div className="p-[20px] border border-gray-200 w-[430px] flex flex-col items-center">
                        ...
                        <div className="flex items-center mt-6">
                         ...
                         <form onSubmit={loginUser} className='flex  w-[100%] flex-col mt-8'>
                            ...
                            <p className='text-sm font-semibold mt-6'>By signing up, you agree to Zapier's
                                 ...
                                 <button type='submit' className='bg-orange-200 rounded mt-6 text-white py-1'>Continue</button>
                         </form>
